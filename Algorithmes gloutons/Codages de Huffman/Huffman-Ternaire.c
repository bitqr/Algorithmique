...
FILE_DE_PRIORITE_TERNAIRE * creerTasTernaire(int longueur, int taille){
     FILE_DE_PRIORITE_TERNAIRE * t = (FILE_DE_PRIORITE_TERNAIRE *) malloc( sizeof(FILE_DE_PRIORITE_TERNAIRE));
     t->longueur = longueur;
     t->taille = taille;
     NOEUD_TERNAIRE ** tab = (NOEUD_TERNAIRE **) malloc( longueur * sizeof(NOEUD_TERNAIRE *));
     int i;

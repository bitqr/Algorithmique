...
int main(int argc, char **argv){
	...
	d->frere_droite = e; e->frere_droite = f; f->frere_droite = g;
	g->frere_droite = nl;
	
	NOEUD *h = creerNoeud(nl,"Zack",3);
	NOEUD *i = creerNoeud(nl,"Julie",8);
	h->frere_droite = i; i->frere_droite = nl;
	...
	k->frere_droite = l; l->frere_droite = nl;
	
	NOEUD *m = creerNoeud(d,"Henry",14);
	NOEUD *n = creerNoeud(h,"Bille",4);
	NOEUD *o = creerNoeud(j,"Levy",0);
	m->frere_droite = n; n->frere_droite = o; o->frere_droite = nl;
	d->p = e->p = f->p = g->p = m;
	h->p = i->p = n; j->p = o;
	...
	p->frere_droite = q; q->frere_droite = r; r->frere_droite = nl;
	k->p = q;
	
	NOEUD *a = creerNoeud(m,"Orson",8);
	NOEUD *b = creerNoeud(p,"Elie",7);
	NOEUD *rac = creerNoeud(a,"Boss",10);
	a->frere_droite = b; b->frere_droite = nl; rac->frere_droite = nl;
	m->p = n->p = o->p = a; p->p = q->p = r->p = b;
	a->p = b->p = rac;
	rac->p = nl;

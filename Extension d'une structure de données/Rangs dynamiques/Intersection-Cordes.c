...
int main(int argc, char **argv){
	NOEUDPOINT *nil = (NOEUDPOINT *)malloc(sizeof(NOEUDPOINT));
	nil->couleur = NOIR;
	nil->taille = 0;
	NOEUDPOINT *rac = creerNoeudRNP(1.0,2,nil,nil,NOIR);
	rac->p = nil;
	ARNP *cordes = creerARNP(rac,nil);
	NOEUDPOINT *c1 = creerNoeudRNP(2.0,3,nil,nil,ROUGE);
	NOEUDPOINT *a1 = creerNoeudRNP(3.0,1,nil,nil,ROUGE);
	NOEUDPOINT *e1 = creerNoeudRNP(4.0,5,nil,nil,ROUGE);
	NOEUDPOINT *c2 = creerNoeudRNP(5.0,3,nil,nil,ROUGE);
	NOEUDPOINT *d1 = creerNoeudRNP(6.0,4,nil,nil,ROUGE);
	NOEUDPOINT *b2 = creerNoeudRNP(7.0,2,nil,nil,ROUGE);
	NOEUDPOINT *e2 = creerNoeudRNP(8.0,5,nil,nil,ROUGE);
	NOEUDPOINT *d2 = creerNoeudRNP(9.0,4,nil,nil,ROUGE);
	NOEUDPOINT *a2 = creerNoeudRNP(10.0,1,nil,nil,ROUGE);
	...
	rac->jumeau = b2; b2->jumeau = rac; 
	c1->jumeau = c2; c2->jumeau = c1;
	a1->jumeau = a2; a2->jumeau = a1;
	d1->jumeau = d2; d2->jumeau = d1;
	e1->jumeau = e2; e2->jumeau = e1;
